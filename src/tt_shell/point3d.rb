require 'tt_shell/point3d_ex.rb'
...
module Point3d
  ...
  #
  # @return [Array<Point3d_Ex>] Geom::Point3d objects extended by Point3d_Ex
  def self.extend_all( points )
    ...
    for point in points
      ...
      point_ex.extend( Point3d_Ex ) unless point_ex.is_a?( Point3d_Ex )
